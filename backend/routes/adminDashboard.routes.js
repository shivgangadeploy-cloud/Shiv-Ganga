...
// router.get(
//   "/admin/dashboard/total-bookings",
//   authMiddleware,
...
// router.get(
//   "/admin/dashboard/today-checkins",
//   authMiddleware,
//   roleMiddleware("admin"),
//   getTodaysCheckIns
// );
...
// router.get(
//   "/admin/dashboard/revenue/monthly",
//   authMiddleware,
//   roleMiddleware("admin"),
//   getMonthlyRevenue
// );
...
// router.get(
//   "/admin/dashboard/occupancy/trends",
//   authMiddleware,
//   roleMiddleware("admin"),
//   getOccupancyTrends
// );
...
// router.get(
//   "/admin/dashboard/receptionists/status",
//   authMiddleware,
//   roleMiddleware("admin"),
//   getReceptionistStatus
// );
...
// router.get(
//   "/admin/dashboard/rooms/utilization-weekly",
//   authMiddleware,
//   roleMiddleware("admin"),
//   getWeeklyRoomUtilization
// );
...
/* ===================== DASHBOARD STATS ===import Booking from "../models/Booking.model.js";
...
router.get(
  "/dashboard/receptionists/status",
  authMiddleware,
  roleMiddleware("admin"),
  getReceptionistStatus,
);
